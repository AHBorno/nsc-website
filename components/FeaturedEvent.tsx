      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            <h2 className="font-mono text-sm tracking-tighter text-sky-500 font-bold mb-2 uppercase">Upcoming Event</h2>
            <h3 className="font-display text-4xl md:text-6xl font-black tracking-tight text-white leading-tight">National Science Fair & Co-curricular Competition-2026</h3>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-sky-500 rounded-3xl p-10 flex flex-col justify-center text-slate-950 items-center text-center shadow-lg shadow-sky-500/25">
            <h4 className="text-[10px] uppercase tracking-[0.3em] font-black mb-4">Take Part Today</h4>
            <p className="text-2xl font-black mb-8 leading-tight">Ready to showcase your talent?</p>
            <motion.a
